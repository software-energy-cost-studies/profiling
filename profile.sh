...
python3 -m cProfile -o cProfile_train.prof  baler/baler.py --mode compress --project profile cpu
python3 -m cProfile -o cProfile_train.prof  baler/baler.py --mode decompress --project profile cpu
